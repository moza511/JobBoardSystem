...
<ul class="list-group">
  ...
  <ul class="list-group">
  <li class="list-group-item d-flex justify-content-between align-items-center">
  <a href="manage-freelancer.php"  id="activ">FreeLancers</a>
    <span class="badge badge-primary badge-pill">14</span>
  </li></ul>
...
<div class="row">
 ...
 <ul class="list-group">
  ...
  $user = $conn->query("SELECT * FROM user,freelancer where user.UserID=freelancer.FreelancerID AND Role='Freelancer' ") or die($conn->error);
...
?>
  ...
  <thead>
      ...
      ?>
        ...
        <td><?php echo $r["ProfessionName"] ?></td>
        <td><?php echo $r["Birthdate"] ?></td>
        <td><?php echo $r["Status"] ?></td>
        <td>
       
        <a href="delete-freelancer.php?id=<?php echo $r['FreelancerID']?>"><span class="fa fa-trash" id="trash"></span></a>
        <a href="update-freelancer.php?id=<?php echo $r['FreelancerID']?>"><span class="fa fa-edit" id="edit"></span></a>

            <?php
            if($r['Status'] == 'Active' ){
            ?>
            <a href="block-freelancer.php?id=<?php echo $r['FreelancerID']?>"><i class="fa fa-eye" id="block" ></i></a>
        
            <?php
            }
            else{
            ?>
            <a href="activate-freelancer.php?id=<?php echo $r['FreelancerID']?>"><span class="fa fa-eye"id="activate"></span></button></a>
