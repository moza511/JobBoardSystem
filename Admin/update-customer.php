...
$user=$conn->query("SELECT *FROM user,customer where user.UserID = $id") or die($conn->error);
...
<br>
    ...
    <hr>
<form action="updtcust-handler.php" method="POST">
  <div class="form-row">
  <div class="form-row">
  ...
  <div class="form-row">
    ...
    <button name="submit" type="submit" class="btn-lg btn-primary">Submit</button>
    </div>
    </div>
