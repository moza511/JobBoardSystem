...
?>
  ...
  <a href="adduser.php"><button class="btn btn-primary btn-xs"><span class="fa fa-plus"></span>&nbsp;New User</button></a>
  </div>
  <thead>
      ...
      ?>
        ...
        <td>
        <a href="delete-user.php?id=<?php echo $r['UserID']?>"><span class="fa fa-trash" id="trash"></span></a>
        <a href="update.php?id=<?php echo $r['UserID']?>"><span class="fa fa-edit success" id="edit"></span></a>

            <?php
            if($r['Status'] == 'Active' ){
            ?>
            <a href="block-user.php?id=<?php echo $r['UserID']?>"><i class="fa fa-eye" id="block" ></i></a>
        
            <?php
            }
            else{
            ?>
            <a href="activate-user.php?id=<?php echo $r['UserID']?>"><span class="fa fa-eye"id="activate"></span></button></a>
