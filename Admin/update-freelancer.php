...
$user=$conn->query("SELECT *FROM user,freelancer where user.UserID = $id") or die($conn->error);
...
<br>
    ...
    <hr>
<form action="updtfree-handler.php" method="POST">
  <div class="form-row">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name="Profession" class="form-control" id="inputEmail4" value='<?php echo $r['ProfessionName']?>'>
    </div>
  </div>
