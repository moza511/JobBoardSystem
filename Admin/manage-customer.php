...
<ul class="list-group">
  ...
  <ul class="list-group">
  <li class="list-group-item d-flex justify-content-between align-items-center">
  <a href="manage-customer.php"  id="activ"> Customers</a>
    <span class="badge badge-primary badge-pill">14</span>
  </li> </ul>
...
<div class="row">
 ...
 <ul class="list-group">
  ...
  $user = $conn->query("SELECT * FROM user,customer where user.UserID=customer.CustomerID AND Role='Customer' ") or die($conn->error);
...
?>
  ...
  <thead>
      ...
      ?>
        ...
        <a href="delete-customer.php?id=<?php echo $r['customerID']?>"><span class="fa fa-trash" id="trash"></span></a>
        <a href="update-customer.php?id=<?php echo $r['customerID']?>"><span class="fa fa-edit success" id="edit"></span></a>

            <?php
            if($r['Status'] == 'Active' ){
            ?>
            <a href="block-customer.php?id=<?php echo $r['customerID']?>"><i class="fa fa-eye" id="block" ></i></a>
        
            <?php
            }
            else{
            ?>
            <a href="activate-customer.php?id=<?php echo $r['customerID']?>"><span class="fa fa-eye"id="activate"></span></button></a>
